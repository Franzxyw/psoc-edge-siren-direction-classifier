...
Infineon, PSOC, ModusToolbox, and DEEPCRAFT are trademarks or registered
trademarks of their respective owners.

## Licensing

The firmware and accompanying Infineon materials are governed by the original
Infineon End User License Agreement preserved in:

```text
firmware/LICENSE
```

No separate open-source license is asserted over the complete repository.
Review the original EULA before copying, modifying, or redistributing the
firmware.
