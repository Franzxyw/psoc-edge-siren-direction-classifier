...
// Model GUID (16 bytes)
#define IMAI_MODEL_ID {0xfe, 0xe4, 0xaf, 0x86, 0x64, 0x3f, 0x14, 0x4c, 0xb1, 0x92, 0x78, 0xfa, 0x0d, 0x9f, 0xea, 0xaa}
...
#define IMAI_DATA_OUT_SYMBOLS {"unlabeled", "Background", "East", "North", "South", "West"}
